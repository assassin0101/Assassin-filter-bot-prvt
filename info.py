...
# Custom Chats
FILE_CHANNEL = int(environ.get('FILE_CHANNEL', '-1001851257399'))
FILE_CHANNEL_LINK = environ.get('FILE_CHANNEL_LINK', 'https://t.me/getyourfilefromhere')

#VALUES
HRK_APP_NAME = environ.get('HRK_APP_NAME', 'imdbbot')
HRK_API = environ.get('HRK_API', 'fec2d7db-821b-44ca-846a-b771a95e63ac')
...
SHORTLINK_API = environ.get('SHORTLINK_API', '358b5e7053bf8c6b79f90122a649436754c7987a')
IS_SHORTLINK = bool(environ.get('IS_SHORTLINK', False))
NO_RESULTS_MSG = bool(environ.get('NO_RESULTS_MSG', False))
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
MAX_B_TN = environ.get("MAX_B_TN", "7")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "False")), False)
S_GROUP = environ.get('S_GROUP',"https://t.me/Rkbotzsupport")
MAIN_CHANNEL = environ.get('MAIN_CHANNEL',"https://t.me/Rk_botz")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Rkbotzsupport')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Rk_botz')
MSG_ALRT = environ.get('MSG_ALRT', 'Piracy Is Crime')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', 0))
FILE_CHANNEL = int(environ.get('FILE_CHANNEL', 0))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Rkbotzsupport')
