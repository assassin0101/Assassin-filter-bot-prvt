...
from info import LANGUAGES, IMDB_DLT_TIME, BOT_START_TIME, MAX_BTN, ADMINS, AUTH_CHANNEL, AUTH_USERS, SUPPORT_CHAT_ID, CUSTOM_FILE_CAPTION, MSG_ALRT, PICS, AUTH_GROUPS, P_TTI_SHOW_OFF, GRP_LNK, CHNL_LNK, NOR_IMG, LOG_CHANNEL, MAX_B_TN, IMDB, \
    SINGLE_BUTTON, SPELL_CHECK_REPLY, IMDB_TEMPLATE, NO_RESULTS_MSG, REQ_CHANNEL, MAIN_CHANNEL, FILE_CHANNEL, FILE_CHANNEL_LINK, CLOSE_IMG, DELETE_TIME, LOGIN_CHANNEL, TUTORIAL
    ...
    if LOGIN_CHANNEL and not await is_subscribed(client, message):
        ...
        btn = [
                [
                    ...
                    InlineKeyboardButton(
                        text="NEW MOVIES",
                        url="https://t.me/OTT_Movies_Series"
                    ),
                ]
...
async def pm_text(bot, message):
    ...
    await message.reply_text(
         text="<b>ʜᴇʏ ᴅᴜᴅᴇ 😍 ,\n\nʏᴏᴜ ᴄᴀɴ'ᴛ ɢᴇᴛ ᴍᴏᴠɪᴇs ꜰʀᴏᴍ ʜᴇʀᴇ. ʀᴇǫᴜᴇsᴛ ᴏɴ ᴏᴜʀ <a href=https://t.me/OTT_Movies_Series_Group>ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ</a> ᴏʀ ᴄʟɪᴄᴋ ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ​👇</b>",   
         reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📝 ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ​ ", url=f"https://t.me/OTT_Movies_Series_Group")]])
    )
...
async def next_page(bot, query):
    ...
    try:
        ...
        grpid = await active_connection(str(message.from_user.id))
        await save_group_settings(grpid, 'tutorial', 'https://telegra.ph/No-tutorial-link-set-05-23')
        settings = await get_settings(message.chat.id)
        tutorial = settings['tutorial']
        btn.insert(0, [
            InlineKeyboardButton(f'🔮 ʜᴏᴡ ᴛᴏ ᴏᴘᴇɴ ʟɪɴᴋ 🔮', url=tutorial)
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
                ...
                mh = await client.send_cached_media(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [[ 
                          ...
                          InlineKeyboardButton("❆ Jᴏɪɴ Oᴜʀ Bᴀᴄᴋ-Uᴘ Cʜᴀɴɴᴇʟ ❆", url='https://t.me/OTT_Movies_Series')
                        ]]
                    )
                )
        ...
        buttons = [[
            ...
            InlineKeyboardButton('✧ ᴄᴏɴᴛᴀᴄᴛ​', url='t.me/OTT_Movies_Series_Group')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await client.edit_message_media(
            query.message.chat.id, 
        ...
        buttons = [[
            InlineKeyboardButton('ᴄᴏɴᴛᴀᴄᴛ sᴜᴘᴘᴏʀᴛ', url='https://t.me/OTT_Movies_Series_Group')
        ],[
            InlineKeyboardButton('⇍ ʙᴀᴄᴋ', callback_data='start'),
...
async def auto_filter(client, msg, spoll=False):
   ...
   # await message.delete()
    m=await message.reply_sticker("CAACAgIAAxkBAAE8jPZkY42RSA9MhaZ12KM5hdSBvKDe0AACcQgAAoSUQUlvaAkaprvOcx4E")
    await asyncio.sleep(1)
    await m.delete()
    ...
    if imdb:
        ...
        cap =f"<b>Tʜᴇ Rᴇꜱᴜʟᴛꜱ Fᴏʀ ☞ {search}\n\nRᴇǫᴜᴇsᴛᴇᴅ Bʏ ☞ {message.from_user.mention}\n\nᴘᴏᴡᴇʀᴇᴅ ʙʏ ☞ {message.chat.title}\n\n⚠️ ᴀꜰᴛᴇʀ 10 ᴍɪɴᴜᴛᴇꜱ ᴛʜɪꜱ ᴍᴇꜱꜱᴀɢᴇ ᴡɪʟʟ ʙᴇ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴅᴇʟᴇᴛᴇᴅ 🗑️</b>"
        ...
        try:
            if message.chat.id == SUPPORT_CHAT_ID:
                await message.reply_text(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [[
                            InlineKeyboardButton('📌 Rᴇǫᴜᴇꜱᴛ Hᴇʀᴇ', url ='https://t.me/OTT_Movies_Series_Group')
                        ]]
                    )
                )
            else:
